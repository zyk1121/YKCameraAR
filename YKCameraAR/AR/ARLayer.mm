...
- (void)setupGL
{
    ...
    self.context = [ARGLContextManager sharedManager].context;
...
- (void)dealloc
{
    ...
    [[ARGLContextManager sharedManager] removeReferenceForContext];
}
