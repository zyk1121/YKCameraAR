...
@property (nonatomic, strong) ARLayer *arLayer;
...
- (void)customUI{
    ...
    [_PhotoButton setImage:[UIImage imageNamed:@"icon_takephoto_normal"] forState: UIControlStateNormal];
    [_PhotoButton setImage:[UIImage imageNamed:@"icon_takephoto_select"] forState:UIControlStateNormal];
...
- (void)customCamera{
    ...
    self.arLayer = [[ARLayer alloc] initWithFrame:self.previewLayer.frame];
    [self.view addSubview:self.arLayer];
//    [self.view.layer addSublayer:self.arLayer.layer];
    //开始启动
